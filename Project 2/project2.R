...
dfselected <- select(df, "bodyfat", "Weight", "Height", "Chest", "Abdomen", "Hip", "Thigh", "Wrist") # selet a few columns
...
mod <- glm(bodyfat~Weight+Height+Chest+Abdomen+Hip+Thigh+Wrist, data=traindata, family="gaussian")
